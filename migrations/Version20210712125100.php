 ...
 */
final class Version20210712125100 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD organisateur_id INT NOT NULL, ADD lieu_id INT NOT NULL, ADD etat_sortie_id INT NOT NULL, ADD campus_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie DROP organisateur_id, DROP lieu_id, DROP etat_sortie_id, DROP campus_id');
    }
}
